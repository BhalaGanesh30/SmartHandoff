"""
services/docs-agent/main.py

Documentation Agent Cloud Run service entry point.
"""
...
SERVICE_NAME = os.environ.get("K_SERVICE", "docs-agent")
init_tracer(service_name=SERVICE_NAME)
configure_logging(service_name=SERVICE_NAME)

app = FastAPI(title="SmartHandoff Docs Agent")
