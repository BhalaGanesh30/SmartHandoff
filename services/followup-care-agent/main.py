"""
services/followup-care-agent/main.py

Follow-up Care Agent Cloud Run service entry point.
"""
...
SERVICE_NAME = os.environ.get("K_SERVICE", "followup-care-agent")
init_tracer(service_name=SERVICE_NAME)
configure_logging(service_name=SERVICE_NAME)

app = FastAPI(title="SmartHandoff Follow-up Care Agent")
