...
- [x] All items in the review checklist above are checked
- [x] PR approved by at least one senior Backend Engineer
- [x] All CI checks passing (`ruff`, `bandit`, `pytest`, `alembic upgrade head`)
- [x] PR merged to `main` branch
- [x] US-006 status updated to `Done` in sprint board
